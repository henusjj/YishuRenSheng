...
- (void)viewDidLoad {
    [super viewDidLoad];
    //    Nav的主题背景色
    [self.navigationBar setBarTintColor:[UIColor colorWithHexString:@"f7f7f7"]];
    
    //    Nav的主题字体大小和颜色
    [self.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName :[UIColor colorWithHexString:@"293959"], NSFontAttributeName : [UIFont systemFontOfSize:18]}];
